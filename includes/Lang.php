...
final class Lang
{
    ...
    private const DICT = [
        ...
        // Page Emplois
        'Emplois, missions & stages' => 'Jobs, projects & internships',
        'Décrochez votre prochaine' => 'Land your next', 'opportunité' => 'opportunity',
        'Des offres d\'entreprises qui recrutent. Postulez en un clic avec votre CV et votre lettre.' => 'Offers from hiring companies. Apply in one click with your resume and cover letter.',
        'Voir les offres' => 'See offers', 'Créer mon profil candidat' => 'Create my candidate profile',
        'Offres récentes' => 'Recent offers', 'Les dernières opportunités publiées.' => 'The latest published opportunities.',
        'Toutes les offres' => 'All offers', 'Voir toutes les offres' => 'See all offers',
        'Mettez en avant vos compétences et votre expérience.' => 'Highlight your skills and experience.',
        'Postulez' => 'Apply', 'Candidatez aux offres qui vous correspondent en un clic.' => 'Apply to matching offers in one click.',
        'Soyez recruté' => 'Get hired', 'Suivez vos candidatures et échangez avec les recruteurs.' => 'Track your applications and chat with recruiters.',
        'Postulez plus vite, avec de meilleurs documents' => 'Apply faster, with better documents',
        'Notre intelligence artificielle analyse chaque offre et votre profil pour :' => 'Our AI analyzes each offer and your profile to:',
        'évaluer votre adéquation avec l\'offre (score sur 100),' => 'assess your fit with the offer (score out of 100),',
        'générer un CV optimisé et téléchargeable (.docx / PDF),' => 'generate an optimized, downloadable resume (.docx / PDF),',
        'rédiger une lettre de motivation personnalisée,' => 'write a personalized cover letter,',
        'importer une offre depuis un lien, un fichier ou une image.' => 'import an offer from a link, a file or an image.',
        'Essayer gratuitement' => 'Try for free', 'Adéquation forte' => 'Strong match', 'Exemple d\'analyse IA' => 'AI analysis example',
        'Docker à renforcer' => 'Docker to strengthen', 'Votre prochain emploi vous attend' => 'Your next job is waiting',
        'Des opportunités en Afrique et à l\'international. Créez votre profil et postulez dès aujourd\'hui.' => 'Opportunities in Africa and internationally. Create your profile and apply today.',
        // Page Prestations
        'Prestations & talents' => 'Services & talent', 'Trouvez le' => 'Find the', 'prestataire' => 'freelancer', 'idéal' => 'you need',
        'Développeurs, designers, consultants… Parcourez des profils qualifiés et contactez-les directement.' => 'Developers, designers, consultants… Browse qualified profiles and contact them directly.',
        'Explorer les profils' => 'Explore profiles', 'Proposer mes services' => 'Offer my services',
        'Cherchez' => 'Search', 'Filtrez par métier, compétence, localisation et budget.' => 'Filter by role, skill, location and budget.',
        'Échangez' => 'Chat', 'Contactez les prestataires via la messagerie sécurisée.' => 'Contact freelancers via secure messaging.',
        'Collaborez' => 'Collaborate', 'Lancez votre projet avec le bon talent.' => 'Start your project with the right talent.',
        'Des talents dans tous les domaines' => 'Talent in every field', 'Parcourez les prestataires par secteur d\'activité.' => 'Browse freelancers by sector.',
        'Vous êtes un talent ? Mettez-vous en avant.' => 'Are you a talent? Stand out.',
        'Créez un profil pro, ajoutez votre portfolio et votre CV, et recevez des opportunités.' => 'Create a pro profile, add your portfolio and resume, and receive opportunities.',
        'Créer mon profil gratuitement' => 'Create my profile for free',
        // Page À propos
        'Connecter les talents et les entreprises' => 'Connecting talent and companies',
        'LULU-OPEN réunit candidats, prestataires et recruteurs sur une plateforme claire, sûre et pensée pour aller à l\'essentiel.' => 'LULU-OPEN brings candidates, freelancers and recruiters together on a clear, safe platform built to get to the point.',
        'Notre mission' => 'Our mission', 'Rendre la rencontre entre offre et demande de compétences simple, rapide et humaine.' => 'Make the match between skills supply and demand simple, fast and human.',
        'Confiance & sécurité' => 'Trust & safety', 'Messagerie sécurisée, profils vérifiés et données protégées, pour échanger en confiance.' => 'Secure messaging, verified profiles and protected data, to interact with confidence.',
        'Efficacité' => 'Efficiency', 'Candidature en un clic, outils IA et tableau de bord centralisé : moins de friction, plus de résultats.' => 'One-click application, AI tools and a centralized dashboard: less friction, more results.',
        'Rejoignez la communauté LULU-OPEN' => 'Join the LULU-OPEN community', 'Créer un compte gratuit' => 'Create a free account',
        // Page Contact
        'Contactez-nous' => 'Contact us', 'Une question, une suggestion ? Notre équipe vous répond rapidement.' => 'A question, a suggestion? Our team replies quickly.',
        'Réactivité' => 'Responsiveness', 'Réponse sous 24–48h ouvrées' => 'Reply within 24–48 business hours',
        'Nom' => 'Name', 'Message' => 'Message', 'Envoyer le message' => 'Send message',
        ...
        'Nos outils analysent les profils et les opportunités pour connecter les bonnes compétences aux bonnes offres — l\'humain garde la main.'
            => 'Our tools analyze profiles and opportunities to connect the right skills to the right offers — humans stay in control.',
        'Votre CV' => 'Your resume', 'Analyse IA' => 'AI analysis', 'CV & lettre adaptés' => 'Tailored resume & letter',
        'Candidature' => 'Application', 'Votre offre' => 'Your offer', 'Profils recommandés' => 'Recommended profiles',
        'Analyse de l\'adéquation de votre CV avec une offre' => 'Fit analysis between your resume and an offer',
        'Génération de CV et de lettres adaptés à chaque offre' => 'Resume and cover letters tailored to each offer',
        'Import d\'une offre depuis un lien, un PDF ou une image' => 'Import an offer from a link, a PDF or an image',
        'Candidature assistée, envoyée en un clic' => 'Assisted application, sent in one click',
        'Utiliser les outils IA' => 'Use the AI tools', 'Recruter avec l\'IA' => 'Hire with AI',
        'Rédaction d\'offre assistée par l\'IA' => 'AI-assisted offer writing',
        'Analyse automatique de chaque candidature' => 'Automatic analysis of every application',
        'Classement des profils par score d\'adéquation' => 'Profiles ranked by fit score',
        'Gagnez du temps sur le tri des candidatures' => 'Save time sorting applications',
        'En savoir plus sur l\'IA de LULU-OPEN' => 'Learn more about LULU-OPEN\'s AI',
        'LULU-OPEN met l\'intelligence artificielle au service de la rencontre entre talents et opportunités. L\'IA accélère et éclaire — les décisions restent humaines.'
            => 'LULU-OPEN puts artificial intelligence at the service of connecting talent and opportunities. AI speeds up and informs — decisions stay human.',
        'Présentez le bon profil, à la bonne offre' => 'Present the right profile, to the right offer',
        'Recrutez plus vite, avec plus de justesse' => 'Hire faster, with more precision',
        'Analyse de CV' => 'Resume analysis', 'Évaluez l\'adéquation de votre CV avec une offre et repérez ce qui manque.' => 'Assess how your resume fits an offer and spot what is missing.',
        'Optimisation de CV' => 'Resume optimization', 'Adaptez votre CV à une offre précise pour maximiser vos chances.' => 'Adapt your resume to a specific offer to maximize your chances.',
        'Lettre de motivation' => 'Cover letter', 'Générez une lettre personnalisée pour chaque candidature.' => 'Generate a personalized letter for each application.',
        'Génération de CV' => 'Resume generation', 'Créez un CV professionnel à partir de votre profil, exportable en .docx.' => 'Create a professional resume from your profile, exportable as .docx.',
        'Import d\'offre' => 'Import an offer', 'Collez un lien, un PDF ou une image : l\'IA en extrait l\'essentiel.' => 'Paste a link, a PDF or an image: AI extracts the essentials.',
        'Candidature assistée' => 'Assisted application', 'Postulez avec un CV et une lettre optimisés, en un clic.' => 'Apply with an optimized resume and letter, in one click.',
        'Rédaction d\'offre' => 'Offer writing', 'L\'IA rédige une offre claire et attractive à partir de vos besoins.' => 'AI writes a clear, attractive offer from your needs.',
        'Analyse des candidatures' => 'Application analysis', 'Chaque candidature reçue est analysée automatiquement.' => 'Every application received is analyzed automatically.',
        'Classement par adéquation' => 'Ranking by fit', 'Les profils les plus pertinents remontent en premier (score de matching).' => 'The most relevant profiles rise to the top (matching score).',
        'Gain de temps' => 'Time saved', 'Concentrez-vous sur les meilleurs profils, moins de tri manuel.' => 'Focus on the best profiles, less manual sorting.',
        'L\'IA est une aide à la décision : elle ne remplace ni votre jugement, ni celui des recruteurs. Vous gardez le contrôle de vos CV, de vos candidatures et de vos choix.'
            => 'AI is a decision aid: it replaces neither your judgment nor that of recruiters. You stay in control of your resumes, applications and choices.',
        'Créez votre compte et laissez l\'IA vous faire gagner du temps.' => 'Create your account and let AI save you time.',
