            ...
            <div class="card">
                <div class="card-body p-4 p-lg-5">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <a class="btn btn-primary" href="<?= e(url('/pricing')) ?>"><i class="bi bi-arrow-up-circle me-1"></i>Changer de plan</a>
                        <a class="btn btn-outline-secondary" href="<?= e(url('/abonnement/portail')) ?>">Gérer le paiement</a>
                    </div>
                </div>
            </div>
            <p class="text-secondary small mt-3 mb-0"><i class="bi bi-shield-lock me-1"></i>Paiements sécurisés. Vous pouvez changer ou annuler à tout moment.</p>
        </div>
    </div>
</section>
