            ...
            <div class="col-md-6">
                <div class="card h-100">
                    <?php if (!empty($s['image_path'])): ?>
                        <img src="<?= e(url('/' . ltrim((string) $s['image_path'], '/'))) ?>" alt="<?= e((string) $s['title']) ?>" style="height:150px;object-fit:cover;border-radius:var(--lulu-radius) var(--lulu-radius) 0 0;" loading="lazy" decoding="async">
                    <?php endif; ?>
