        ...
        <div class="col-lg-10">
            <div class="card" style="border-color: var(--bs-danger-border-subtle, #f1aeb5);">
                <div class="card-body p-4">
                    ...
                    <p class="text-secondary mb-3">Action <strong>définitive et irréversible</strong> : suppression de l'ensemble de vos données (profil entreprise, offres, candidatures reçues, messages…), conformément au RGPD.</p>
