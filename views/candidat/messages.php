...
<body>
<?php
// Récupérer les informations utilisateur pour le sidebar
$stmt = $db->prepare("SELECT * FROM utilisateurs WHERE id = ?");
$stmt->execute([$_SESSION['user_id']]);
$user = $stmt->fetch(PDO::FETCH_ASSOC);

renderSidebar($_SESSION['user_type'], 'messages.php', $user);
?>
    ...
    <div class="main-content">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?= url('views/' . $_SESSION['user_type'] . '/dashboard.php') ?>">Dashboard</a></li>
