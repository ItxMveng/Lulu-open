...
<body>
    ...
    <div class="admin-content">
        ...
        <?php if ($subscriptionStatus && $subscriptionStatus['subscription_status'] === 'Actif'): ?>
            <?php
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-body text-center p-5">
                    ...
                    <h4 class="mb-3 text-success fw-bold">Demande soumise avec succès !</h4>
                    <p class="text-muted mb-4" id="successMessage">
                        Votre demande d'abonnement a été soumise avec succès. Elle est actuellement en attente de vérification par notre équipe. Aucun paiement n'a été prélevé. Vous recevrez une notification dès que votre abonnement sera activé.
                    </p>
    ...
    <script>
        ...
        document.getElementById('subscriptionForm').addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch('/lulu/controllers/SubscriptionController.php?action=submitRequest', {
                    method: 'POST',
                    body: formData
                });
                ...
                if (result.success) {
                    ...
                    modal.show();
                    // Recharger après fermeture du modal
