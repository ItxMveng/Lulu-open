    ...
    <div class="profile-header mb-5">
        <div class="row align-items-center">
            ...
            <div class="col-lg-9">
                ...
                <?php if ($profileType === 'dual'): ?>
                    <h2 class="profile-title text-success">Prestataire & Candidat</h2>
                <?php elseif ($profileType === 'prestataire'): ?>
                    <h2 class="profile-title text-primary">Prestataire de services</h2>
                <?php else: ?>
                    <h2 class="profile-title text-info">Chercheur d'emploi</h2>
                <?php endif; ?>
